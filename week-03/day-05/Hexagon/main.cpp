...
{ if (counter > 0){
        ...
        SDL_Point points[7] = // edge of the hexagon
                {
        ...
        //up left
        draw((x_minimum + (x_maximum - x_minimum)/6), (x_minimum + (x_maximum - x_minimum)/ 2),
                y_minimum, (y_minimum + (y_maximum - y_minimum)/6*2), counter-1);
        // up right
        draw((x_minimum + (x_maximum - x_minimum)/ 2),(x_minimum + (x_maximum - x_minimum)/6*5),
             y_minimum, (y_minimum + (y_maximum - y_minimum)/6*2), counter-1);
        //middle left
        draw(x_minimum,(x_minimum + (x_maximum - x_minimum)/3),
             (y_minimum + (y_maximum - y_minimum)/6*2), (y_minimum + (y_maximum - y_minimum)/6*4), counter-1);
        //middle right
        draw((x_minimum + (x_maximum - x_minimum)/3*2), x_maximum,
             (y_minimum + (y_maximum - y_minimum)/6*2), (y_minimum + (y_maximum - y_minimum)/6*4), counter-1);
        //down left
        draw((x_minimum + (x_maximum - x_minimum)/6), (x_minimum + (x_maximum - x_minimum)/ 2),
              (y_minimum + (y_maximum - y_minimum)/6*4), y_maximum, counter-1);
        //down right
        draw((x_minimum + (x_maximum - x_minimum)/ 2),(x_minimum + (x_maximum - x_minimum)/6*5),
             (y_minimum + (y_maximum - y_minimum)/6*4), y_maximum, counter-1);
    }

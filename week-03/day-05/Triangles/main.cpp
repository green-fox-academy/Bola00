...
{ if (counter > 0) {
        SDL_Point points[4] ={
                {x_minimum, y_minimum},
                {x_maximum, y_minimum},
                {(x_minimum + (x_maximum - x_minimum)/2 ), y_maximum},
                {x_minimum, y_minimum}
                   };
        ...
        draw(x_minimum,(x_minimum + (x_maximum - x_minimum)/2),
                y_minimum, (y_minimum + (y_maximum  - y_minimum)/2 ),  counter -1 );

        draw((x_minimum + (x_maximum - x_minimum)/2), x_maximum, y_minimum,
                (y_minimum + (y_maximum  - y_minimum)/2 ),  counter -1 );

        draw((x_minimum + (x_maximum - x_minimum)/4), (x_minimum + (x_maximum - x_minimum)/4*3),

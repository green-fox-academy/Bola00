...
void draw(){
    ...
    int x = 100;
    int y = 60;
    int a [5] = {0x00,0x00, 0xFF, 0x00, 0x00};

    for (int i = 1; i <= 3; i++){
    SDL_SetRenderDrawColor(gRenderer, a[5 - i] /*R*/, a[4 - i] /*G*/, a[3 - i] /*B*/, 0xFF /*A*/);
        SDL_Rect fillRect = { (x*i), (y*i), SCREEN_WIDTH - (x*i*2), SCREEN_HEIGHT - (x*i*2)};

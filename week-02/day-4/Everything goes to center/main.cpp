...
void draw(int x, int y)
{
    ...
    SDL_SetRenderDrawColor(gRenderer, 50, 130, 200, 255);
    ...
    for (int i = 0; i <=480; i+=20){
        SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH, i, SCREEN_WIDTH/2, SCREEN_HEIGHT/2);
    }
    for (int i = 0; i <=640; i+=20){
        SDL_RenderDrawLine(gRenderer, i, 0, SCREEN_WIDTH/2, SCREEN_HEIGHT/2);
    }
    for (int i = 0; i <=640; i+=20){
        SDL_RenderDrawLine(gRenderer, i, SCREEN_HEIGHT, SCREEN_WIDTH/2, SCREEN_HEIGHT/2);
    }

...
/* generate secret number between 1 and 10: */
        int random_grey = rand() % 100 + 100;
        int random_x = rand() % 635 + 1;
        int random_y = rand() % 475 + 1;
        SDL_SetRenderDrawColor(gRenderer, random_grey, random_grey, random_grey, 255);
//create a rectangle
        SDL_Rect fillRect = {random_x, random_y, 5, 5};
//draw rectangle
